...
- (instancetype)initWithDataSource:(OSDataSource *)dataSource
{
    self = [super init];
    if (!self)
        return nil;
...
+ (BOOL)instancesRespondToSelector:(SEL)selector
{
    ...
    return class_respondsToSelector(self, selector) || [UITableView instancesRespondToSelector:selector] || [UICollectionView instancesRespondToSelector:selector];
