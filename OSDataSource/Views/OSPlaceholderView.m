...
{
    NSAssert(NO, @"-[OSPlaceholderView initWithFrame:] will not return a usable view");
    return nil;
}
...
{
    OSPlaceholderView *placeholderView = _placeholderView;
...
{
    OSPlaceholderView *oldPlaceHolder = self.placeholderView;
